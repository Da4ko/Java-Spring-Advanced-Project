...
public class OthersPorscheCarDto {
    private String id;
    ...
    public OthersPorscheCarDto() {
    }

    public OthersPorscheCarDto(PorscheCar porscheCar) {
        ...
        this.ownerUsername = porscheCar.getOwner().getUsername();
    }
